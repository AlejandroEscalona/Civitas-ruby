...
#  ATTR get_hipotecado, get_importe_hipoteca, get_importe_cancelar_hipoteca....get_propietario
  ...
  def to_s
    return "CASILLA:"+@nombre+
                "\n  alquilerBase:"+@alquiler_base.to_s+"  factorInteresesHipoteca:"+@@factor_intereses_hipoteca.to_s+
                "\n  factorRevalorizacion:"+@factor_revalorizacion.to_s+"  hipotecaBase:"+@hipoteca_base.to_s+
                "\n  hipotecado:"+@hipotecado.to_s+"  numCasas:"+@num_casas.to_s+"  numHoteles:"+@num_hoteles.to_s+
                "\n  precioCompra:"+@precio_compra.to_s+"  precioEdificar:"+@precio_edificar.to_s+
