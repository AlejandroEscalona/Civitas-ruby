...
module Civitas
  class Jugador
    ...
    def initialize(n)
      ...
      puts "****"+@num_casilla_actual.class.name+"****"
    ...
    def copia(otro)
      ...
      @nombre = otro.nombre
      puts "----"+otro.num_casilla_actual.class.name+"----"
    ...
    def to_s
      ...
      return "Jugador: "+ nombre+"  -Casilla actual: "+num_casilla_actual.to_s+" -¿está encarcelado?: "+encarcelado.to_s+" -¿puede comprar?: "+puede_comprar.to_s+" -Numero de propiedades: #{+@propiedades.size} -Saldo: "+saldo.to_s
    end
    ...
    def pasa_por_salida
      ...
      Diario.instance.ocurre_evento("El jugador #{@nombre} cobró el paso por salida")
      return true
    end
